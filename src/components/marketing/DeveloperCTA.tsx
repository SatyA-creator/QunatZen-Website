...
const DeveloperCTA = () => {
  return (
    <section className="py-24 bg-gradient-to-br from-quantum-dark to-background overflow-x-hidden w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-full">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 px-4 sm:px-0">
            {[
              {
                icon: Code2,
                title: "Quick Start",
