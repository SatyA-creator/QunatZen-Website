...
const threats = [
  {
    ...
    quantzenSolution: "PQ keys generated with high‑entropy RNG, stored in secure enclaves/keystores. Even if ECDSA keys leak, the forged PQ signature is still required - theft fails"
  },
  {
    ...
    quantzenSolution: "Dual signature + metadata‑bound prompts make “invisible approvals” unverifiable and safer to detect."
  },
  {
    ...
    quantzenSolution: "Unforgeable PQ audit trail makes user intent verifiable for enterprises, regulators, and courts."
  },
  {
    ...
    quantzenSolution: "PQ signature is bound to timestamp/nonce/amount/recipient - copy‑pasting a mempool txn won’t verify."
  },
  {
    ...
    quantzenSolution: "Dual signatures are chain‑scoped and tied to nonce + chainID - replays fail across Polygon/BNB/Ethereum etc"
  },
  {
    ...
    quantzenSolution: "Wrap QuantZen into custody signing flows to create a provable, tamper‑evident audit trail for cross‑chain movements."
  },
  {
    threat: "Insider risks",
    description: "Quantum algorithms reverse-engineering private keys from public addresses",
    impact: "Trusted individuals can exploit access for fraud or theft.",
    quantzenSolution: "All privileged actions require dual signing and are logged; insiders cannot quietly deny/erase actions."
  },
  {
    threat: "Harvest‑Now‑Decrypt‑Later (HNDL)",
    description: "Quantum algorithms reverse-engineering private keys from public addresses",
    impact: "Future quantum attacks can expose today’s encrypted data.",
    quantzenSolution: "Every new txn carries a PQC signature, so your history remains safe even if ECDSA breaks in the 2030s."
  }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                  ...
                  <div className="p-8 bg-gradient-to-br from-quantum-primary/10 to-quantum-primary/5 lg:col-span-2">
                    <div className="flex items-start space-x-3">
                      ...
                      >
                        <Shield className="w-6 h-6 text-quantum-primary mt-1 flex-shrink-0" />
                      </motion.div>
                      <div>
                        <h4 className="text-lg font-bold text-quantum-primary mb-2 flex items-center">
                        ...
                        <motion.div
                          ...
                          className="mt-4 bg-quantum-primary/20 rounded-lg p-3"
                        >
        ...
        >
          <div className="bg-gradient-to-r from-quantum-primary/10 to-secondary/10 rounded-2xl p-8 max-w-4xl mx-auto border border-quantum-primary/20">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-2xl font-bold">Comprehensive Quantum Defense</h3>
            </div>
            <p className="text-muted-foreground text-lg leading-relaxed">
              QuantZen's multi-layered security approach addresses every known quantum attack vector against Web3 infrastructure. 
              Our protection is proactive, not reactive—securing your assets before quantum computers pose an existential threat.
            </p>
          </div>
        </motion.div>
      </div>
